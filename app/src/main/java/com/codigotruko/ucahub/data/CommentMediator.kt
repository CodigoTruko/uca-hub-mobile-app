...
class CommentMediator(
    ...
    private val idPublication: String,
    ...
    private var commentDao = database.commentDao()
    ...
    override suspend fun load(
        ...
        try {
            ...
            val response = ucaHubService.getPublicationComments(
                token,
                idPublication,
            ...
            database.withTransaction {
                ...
                if (response != null) {
                    commentDao.insertAll(response.results)
                }
                if (response != null) {
